...
import { updateTitle, remSpaces, isNotUndefined} from '../../../utils/utils';
...
const Products = (props) =>{
    ...
    useEffect(()=>{
        let filterva = categories.find(product => remSpaces(product.name) == location.pathname.split("/")[2]);
        handleCategoryFilter(filterva ? filterva.id : "All");
    },[]);
